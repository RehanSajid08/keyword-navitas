...
const FeatureCard = ({ icon, title, description, index = 0, className }: FeatureCardProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "group rounded-xl overflow-hidden border border-gray-100 dark:border-gray-800 p-6 bg-white dark:bg-gray-900 hover:shadow-lg transition-all duration-300",
        className
      )}
    >
